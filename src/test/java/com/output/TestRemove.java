...
import com.output.DataConvertFactory;
import com.output.DataConvertStrategy;
...
public class TestRemove {
    ...
    public void test1RemoveStage() {
        DataConvertStrategy dataConvertStrategy = DataConvertFactory.getDataConvertStrategy(1);
        String test1 = "aabcccbbad";
        List<String> testResult1 =  dataConvertStrategy.convert(test1,0);
        assertEquals("aabbbad", testResult1.get(0));
        assertEquals("aaad", testResult1.get(1));
        assertEquals("d", testResult1.get(2));
    }
    ...
    public void test2RemoveStage() {
        ...
        System.out.println(testResult2.get(0));
        System.out.println(testResult2.get(0).getClass());
        assertEquals("", testResult2.get(0));
    }
    ...
    public void test4RemoveStage() {
        DataConvertStrategy dataConvertStrategy = DataConvertFactory.getDataConvertStrategy(1);
        String test4 = "aabbccdddcba";
        List<String> testResult2 = dataConvertStrategy.convert(test4,0);
        assertEquals("aabbcccba", testResult2.get(0));
        assertEquals("aabbba", testResult2.get(1));
        assertEquals("aaa", testResult2.get(2));
        assertEquals("", testResult2.get(3));
    }
    ...
    public void test8RemoveStage() {
        ...
        assertEquals("", testResult8.get(0));
    }
    ...
    public void test9RemoveStage() {
        ...
        assertEquals("", testResult9.get(0));
    }
    ...
    public void test10RemoveStage() {
        ...
        assertEquals("abbad", testResult10.get(0));
    }
}
